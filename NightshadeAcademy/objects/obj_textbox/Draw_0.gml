...
if draw_char == text_length[page] && page == page_number - 1{
	...
	//option box
		...
		draw_sprite_ext(txtb_spr, txtb_img, _txtb_x + 16, _txtb_y - _op_bord*option_number + _op_space*op, _o_w/txtb_spr_w, (_op_space-1)/txtb_spr_h, 0, c_white, 1);
	//arrow
	if option_pos == op{
		draw_sprite(spr_textbox_arrow, 0, _txtb_x, _txtb_y - _op_bord*option_number + _op_space*op);
	}
	//options
	draw_text(_txtb_x + 16 + _op_bord, _txtb_y - _op_bord*option_number + _op_space*op + 2, option[op]);
	}
}
//draw the text
