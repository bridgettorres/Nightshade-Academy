function scr_game_text(_text_id){
	switch(_text_id){
		...
		case "hmr_quiz":
			...
			scr_text("Homeroom Teacher: Everyone Welcome Jett! Since they're new here, I thought we'd test their knowledge of our lovely boarding school.");
		//	scr_text("Homeroom Teacher: First question, What year was this school founded?");
		...
		break;
		case "breakingpoint":
			scr_text("cCHECKING AWHdnfklrwenflwe");
		break;
